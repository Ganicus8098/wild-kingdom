(() => {
    ...
    function initSliders() {
        if (document.querySelector(".better-mini-world__slider")) new swiper_core_Swiper(".better-mini-world__slider", {});
        if (document.querySelector(".better-world__slider")) new swiper_core_Swiper(".better-world__slider", {
            ...
            navigation: {
                prevEl: ".better-world__arrow--right",
                nextEl: ".better-world__arrow--left"
            },
            thumbs: {
                swiper: {
                    el: ".better-mini-world__slider",
                    slidesPerView: 4,
                    spaceBetween: 10,
                    loop: true
                }
        ...
        if (document.querySelector(".pet-dialog__slider")) new swiper_core_Swiper(".pet-dialog__slider", {
            ...
            navigation: {
                prevEl: ".pet-dialog__arrow--right",
                nextEl: ".pet-dialog__arrow--left"
            },
            on: {}
        });
    }
